"""Conservative Korean register policy provider.

The observer recognizes only a small set of high-confidence terminal forms.
Ambiguous, mixed, quoted, or markup-heavy text is deliberately inconclusive.
"""
...
_POLICY_KEYS = frozenset(
    {"politeness", "ending_families", "forbidden_families"}
)
